PotatoPi
PotatoPi is an RP2040-based microcontroller designed for hand soldering. It follows the same pinout as the Raspberry Pi Pico and is fully feature-compatible.
